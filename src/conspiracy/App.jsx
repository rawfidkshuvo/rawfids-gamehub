...
const appId = typeof __app_id !== "undefined" ? __app_id : "conspiracy";
const GAME_ID = "1";
...
export default function ConspiracyGame() {
  ...
  const [roomId, setRoomId] = useState(() => {
    ...
    if (sessionStorage.getItem("splashRefreshed")) {
      ...
      return localStorage.getItem("conspiracy_roomId") || "";
    }
    return "";
  });
  ...
  if (view === "lobby" && gameState) {
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 relative">
        <DarkAtmosphere />
        <ConspiracyLogoBig />
        <div className="z-10 w-full max-w-lg bg-slate-900/90 backdrop-blur p-8 rounded-2xl border border-purple-900/50 shadow-2xl">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-1">
                ...
                <div className="relative">
                  ...
                  {/* 3. The Copied Popup */}
                  {isCopied && (
                    <div className="absolute left-full ml-2 top-1/2 -translate-y-1/2 bg-purple-500 text-white text-xs font-bold px-2 py-1 rounded shadow-lg animate-fade-in-up whitespace-nowrap">
                      Copied!
                    </div>
                  )}
                </div>
  ...
  if (view === "game" && gameState) {
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white overflow-hidden flex flex-col relative font-sans">
        <DarkAtmosphere />
