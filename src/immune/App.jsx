...
const FeedbackOverlay = ({ type, message, subtext, icon: Icon }) => (
  <div className="fixed inset-0 z-[300] flex items-center justify-center pointer-events-none animate-in fade-in zoom-in duration-200">
    <div
      className={`flex flex-col items-center justify-center p-4 sm:p-12 rounded-3xl border-2 sm:border-4 shadow-2xl backdrop-blur-xl max-w-[85vw] sm:max-w-xl mx-auto text-center ${
        type === "success"
  ...
  <div className="fixed inset-0 z-[200] bg-slate-950/95 backdrop-blur-md flex items-center justify-center p-2 sm:p-4">
    <div className="bg-slate-900 border border-emerald-900/50 w-full max-w-4xl rounded-2xl sm:rounded-3xl shadow-2xl relative max-h-[90vh] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-6 space-y-6 sm:space-y-8 text-slate-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-emerald-950/30 p-4 sm:p-5 rounded-2xl border border-emerald-900/50 shadow-inner">
            ...
            <p className="text-sm leading-relaxed">
              ...
              <strong>4 different healthy organs</strong>. An organ is "healthy"
              if it has{" "}
          ...
          <div className="bg-blue-950/30 p-4 sm:p-5 rounded-2xl border border-blue-900/50 shadow-inner">
            ...
            <p className="text-sm leading-relaxed">
              You must do exactly <strong>one</strong> of two things:
              <br />
              ...
              <br />
              <em className="block mt-2 text-[10px] sm:text-xs opacity-75">
        ...
        <div>
          <h3 className="text-xl sm:text-2xl font-black text-white mb-4 flex items-center gap-2">
            <FlaskConical className="text-amber-400 w-6 h-6" /> Anatomy &
            Infection
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-black/40 p-4 rounded-2xl border border-white/5 shadow-inner">
              <div className="flex items-center gap-2 mb-2 text-cyan-400 font-black tracking-widest">
                <HeartPulse className="w-5 h-5" /> ORGANS
              </div>
              <p className="text-xs sm:text-sm">
                Place these in front of you. You cannot have two organs of the
                same color. Collect 4 different healthy ones to win.
              </p>
            </div>
            <div className="bg-rose-950/20 p-4 rounded-2xl border border-rose-900/30 shadow-inner">
              <div className="flex items-center gap-2 mb-2 text-rose-400 font-black tracking-widest">
              ...
              <p className="text-xs sm:text-sm">
                ...
                <span className="block mt-2">
                  • <strong>1 Virus:</strong> Infects it (stops them from
                  winning).
                </span>
                <span className="block mt-1">
                  • <strong>2 Viruses:</strong> Destroys the organ entirely!
                </span>
                <span className="block mt-1">
                  • <strong>vs Medicine:</strong> Destroys a vaccine.
                </span>
              </p>
            </div>
            <div className="bg-amber-950/20 p-4 rounded-2xl border border-amber-900/30 shadow-inner">
              <div className="flex items-center gap-2 mb-2 text-amber-400 font-black tracking-widest">
                <Pill className="w-5 h-5" /> MEDICINES
              </div>
              <p className="text-xs sm:text-sm">
                Play on your organ of the <strong>same color</strong>.<br />
                <span className="block mt-2">
                  • <strong>vs Virus:</strong> Cures/removes an infection.
                </span>
                <span className="block mt-1">
                  • <strong>1 Medicine:</strong> Vaccinates the organ.
                </span>
                <span className="block mt-1">
                  • <strong>2 Medicines:</strong> IMMUNIZES it permanently!
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-gradient-to-r from-rose-900/20 via-emerald-900/20 to-blue-900/20 p-3 sm:p-4 rounded-xl border border-white/10 flex items-center gap-3 shadow-inner">
            ...
            <p className="text-xs sm:text-sm">
              <strong className="text-white tracking-widest uppercase">
                The Multicolor Wildcard:
              </strong>{" "}
              Rainbow organs can take ANY virus or medicine. Rainbow
              viruses/medicines can be played on ANY organ!
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className="flex gap-3 bg-fuchsia-950/20 p-3 sm:p-4 rounded-xl border border-fuchsia-900/30 items-start shadow-inner">
              ...
              <div>
                <strong className="text-fuchsia-300 block mb-1 tracking-widest">
                  ORGAN THIEF
                </strong>
                <p className="text-xs sm:text-sm opacity-90">
                  Steal an organ from another player and add it to your body.
                  You can steal healthy, vaccinated, or infected organs, but{" "}
                  <strong>not</strong> immunized ones.
                </p>
              </div>
            </div>
            <div className="flex gap-3 bg-fuchsia-950/20 p-3 sm:p-4 rounded-xl border border-fuchsia-900/30 items-start shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm opacity-90">
                  Swap any two organs between any two players (yours or theirs).
                  Cannot swap immunized organs.
                </p>
              </div>
            </div>
            <div className="flex gap-3 bg-fuchsia-950/20 p-3 sm:p-4 rounded-xl border border-fuchsia-900/30 items-start shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm opacity-90">
                  Move viruses from your infected organs to any valid free
                  organs belonging to your opponents.
                </p>
              </div>
            </div>
            <div className="flex gap-3 bg-fuchsia-950/20 p-3 sm:p-4 rounded-xl border border-fuchsia-900/30 items-start shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm opacity-90">
                  All other players instantly discard their entire hand. They
                  miss their next turn to draw back up to 3 cards.
                </p>
              </div>
            </div>
            <div className="flex gap-3 bg-fuchsia-950/20 p-3 sm:p-4 rounded-xl border border-fuchsia-900/30 items-start sm:col-span-2 shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm opacity-90">
                  ...
                  medicines) with another player! This is the only card that
                  ignores immunizations.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="shrink-0 p-4 sm:p-6 border-t border-white/10 bg-black/40 flex justify-center">
        <button
          onClick={onClose}
          className="w-full sm:w-auto px-10 py-3 sm:py-4 rounded-xl font-bold text-sm sm:text-base shadow-[0_0_20px_rgba(16,185,129,0.4)] transition-all bg-emerald-600 hover:bg-emerald-500 text-white hover:scale-105 tracking-widest uppercase"
        >
          Got It, Let's Play
        </button>
      </div>
...
const SplashScreen = ({ onStart }) => {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem("immune_roomId");
    setHasSession(!!saved);
...
export default function ImmuneGame() {
  ...
  const returnToLobby = async () => {
    ...
    // Added wins: 0 to wipe the history for the next game
  ...
  const executeAction = async (actionType, params = null) => {
    ...
    try {
      if (actionType === "ORGAN") {
        ...
        logs.push(
          triggerLog(
            `${me.name} used Latex Glove! Everyone else discarded their hands.`,
            "failure",
            true,
            "LATEX GLOVE",
          ),
  ...
  const finishTurn = async (state, logs) => {
    ...
    if (winner) {
      ...
      logs.push(
        triggerLog(
          `${winner.name} has completed their body!`,
          "important",
          true,
          "VICTORY!",
        ),
  ...
  const isPlayerTargetable = (playerId, me) => {
    if (selectedCards.length !== 1) return false;
    const card = me.hand[selectedCards[0]];
    if (card.type === "ACTION" && card.action === "ERROR" && playerId !== me.id)
      return true;
    return false;
  };
            ...
            .map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`grid gap-2 justify-items-center ${p.body.length === 5 ? "grid-cols-3" : "grid-cols-2"}`}
                  >
                    {p.body.map((organ) => (
                      <OrganView
                        key={organ.id}
                        ...
                        onClick={() => {
                          if (isOpponentOrganTargetable(organ, me))
            ...
            {me?.body.map((organ) => (
              <div key={organ.id} className="shrink-0">
                <OrganView
                  ...
                  onClick={() => {
                    if (isMyOrganTargetable(organ, me))
