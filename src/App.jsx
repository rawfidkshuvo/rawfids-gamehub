...
const INITIAL_GAMES = [
  ...
  },
  {
    ...
    title: "Lucky Seven",
    description:
      "A high-stakes game of chance and strategy. Flip cards, risk it all, and aim for the elusive Lucky Seven to claim victory.",
  ...
  const processedGames = useMemo(() => {
    return INITIAL_GAMES.map((game) => {
      ...
      return {
        ...
        betaTesting: override.betaTesting || false, // <--- ADD THIS LINE
