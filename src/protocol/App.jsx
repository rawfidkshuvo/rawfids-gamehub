...
const APP_ID = typeof __app_id !== "undefined" ? __app_id : "protocol-sabotage";
const GAME_ID = "8";
      ...
      return (
        <div
          ...
          style={{
            ...
            backgroundColor: Math.random() > 0.5 ? "#00b3ff" : "#241ed4",
            animationDuration: `${10 + Math.random() * 20}s`,
            animationDelay: `${Math.random() * -20}s`,
            boxShadow: "0 0 12px 2px rgba(3, 133, 255, 0.8)", // Brighter glow
...
export default function ProtocolGame() {
  ...
  const [roomId, setRoomId] = useState(() => {
    ...
    if (sessionStorage.getItem("splashRefreshed")) {
      ...
      return localStorage.getItem("protocol_roomId") || "";
    }
    return "";
  });
